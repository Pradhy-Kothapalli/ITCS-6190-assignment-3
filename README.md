...
<img width="1612" height="370" alt="image" src="https://github.com/user-attachments/assets/511772dd-345b-4df6-bf94-65d2bb150d68" />
Following the instructions, I first created the buckets with the required folders
...
![IAM Roles](Screenshot%202026-04-21%20220728.png)
I then created these roles to allow AWS services to access s3 and interact with each other
...
![Lambda Function](Screenshot%202026-04-21%20220756.png)
I created a Lambda function to automatically process and filter CSV files uploaded to S3.
...
![Trigger](Screenshot%202026-04-21%20220812.png)
I configured the S3 trigger so the Lambda function runs automatically when a CSV file is uploaded into the `raw/` folder.
...
![Processed data](Screenshot%202026-04-21%20220848.png)
This shows the filtered CSV file generated by the Lambda function in the processed folder.
---
...
7.  Finish the setup and run the crawler. It will create a new table in your `orders_db` database.
 ![Crawler Logs](Screenshot%202026-04-21%20220632.png)
I ran a Glue crawler to scan the processed data and create a table, and this shows the crawler logs.
...
![Athena Results](Screenshot%202026-04-21%20220907.png)

I used Athena to run SQL queries on the processed data, and this shows the query results stored in S3.
There was an error initially since the correct output file was not being referenced but that was a simple fix
...
![Webpage](Screenshot%202026-04-21%20220050.png)
I deployed the web application on EC2 to show the Athena query results in a dashboard.
